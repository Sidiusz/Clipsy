...
public static class Strings
{
    private static readonly Dictionary<string, Dictionary<string, string>> _all = new()
    {
        ...
        ["HelperEyedropperMod"] = New("Hold this key while a draw tool is active to pick a color.", "Удерживайте эту клавишу при рисовании, чтобы взять цвет с экрана."),
        ...
        ["TipSelectMonitor"]      = New("By default Ctrl+B selects the monitor under the cursor.", "По умолчанию Ctrl+B выбирает монитор под курсором."),
