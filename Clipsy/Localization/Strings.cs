...
public static class Strings
{
    private static readonly Dictionary<string, Dictionary<string, string>> _all = new()
    {
        ...
        ["LblStorage"]          = New("Files and saving",          "Файлы и сохранение"),
        ["LblCaptureScreenshots"] = New("Screenshots",              "Скриншоты"),
        ["LblCaptureOverlay"]   = New("Capture overlay",           "Окно захвата"),
        ["LblRecordingOutput"]  = New("Output",                    "Вывод"),
        ["LblRecordingAudio"]   = New("Audio",                     "Звук"),
        ["LblRecordingEncoder"] = New("Encoder",                   "Кодирование"),
        ...
        ["HelperVideoFormat"]   = New("Format used for quick save.", "Формат при быстром сохранении."),
        ...
        ["HelperEyedropperMod"] = New("Hold Alt, Ctrl, Shift, or a custom key while drawing to pick a color.", "Удерживайте Alt, Ctrl, Shift или назначенную клавишу во время рисования, чтобы взять цвет с экрана."),
        ["OptEyedropperCustom"]   = New("Custom key…",                 "Своя клавиша…"),
        ["LblEyedropperCopyHex"]  = New("Copy picked HEX",              "Копировать HEX цвета"),
        ["HelperEyedropperCopyHex"] = New("Copy the selected color as #RRGGBB to the clipboard.", "После выбора цвета копировать #RRGGBB в буфер обмена."),
        ...
        ["LblAutoDownload"]      = New("Auto-download updates",     "Автоматически скачивать обновления"),
        ...
        ["CodecAv1Desc"]        = New("High compression via FFmpeg; CPU-intensive. Pause, live region resize, and microphone switching are unavailable during recording.", "Высокое сжатие через FFmpeg, сильно нагружает CPU. Во время записи недоступны пауза, изменение области и переключение микрофона."),
        ...
        ["OptWebpPreview"]      = New("WebP (web format)", "WebP (веб-формат)"),
        ...
        ["ChangelogTitle"]        = New("Changelog",           "Список изменений"),
        ["ChangelogCurrent"]      = New("current",             "текущая"),
        ["ChangelogNew"]          = New("new",                 "новая"),
        ["ChangelogHeader"]       = New("Current: {0}    New: {1}", "Текущая: {0}    Новая: {1}"),
        ["ChangelogLoading"]      = New("Loading releases…",   "Загрузка релизов…"),
        ["ChangelogEmptyOrFail"]  = New("Could not load the changelog. Check your connection.", "Не удалось загрузить список изменений. Проверьте подключение."),
        ...
        ["HelperGifDither"]       = New("Blends palette colors to reduce banding in gradients, but slightly increases file size. Default: on.", "Смешивает цвета палитры, скрывая полосы на градиентах, но немного увеличивая размер файла. По умолчанию: вкл."),
        ...
        ["TipSelectAll"]          = New("By default Ctrl+A selects every monitor at once.", "По умолчанию Ctrl+A выбирает все мониторы сразу."),
        ["TipSelectMonitor"]      = New("By default Ctrl+B selects the screen under the pointer.", "По умолчанию Ctrl+B выбирает экран под указателем мыши."),
        ...
        ["TipEyedropperSettings"]         = New("Use the eyedropper to pick any color from the screen while drawing.", "Пипеткой можно взять любой цвет с экрана прямо во время рисования."),
        ...
        ["HkGroupEditing"]        = New("Editing", "Редактирование"),
